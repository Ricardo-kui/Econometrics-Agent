...
SMTP_FROM_EMAIL = os.environ.get("SMTP_FROM_EMAIL", os.environ.get("EMAIL_FROM", ""))
SMTP_FROM_NAME = os.environ.get("SMTP_FROM_NAME", os.environ.get("EMAIL_FROM_NAME", "Econometrics Agent"))
...
FRONTEND_URL = os.environ.get("FRONTEND_URL", os.environ.get("WEBUI_BASE_URL", "http://localhost:5173"))
